...
export class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render(): ReactNode {
    if (this.state.hasError) {
      return (
        <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Inter', sans-serif", color: "var(--ink)", background: "var(--bg-main)" }}>
          <div style={{ textAlign: "center", maxWidth: 420, padding: "2rem" }}>
            ...
            <button
              ...
              style={{ border: 0, borderRadius: 10, padding: "0.7rem 1.5rem", background: "var(--accent)", color: "#fff", fontSize: "1rem", fontWeight: 700, cursor: "pointer" }}
            >
              Reload
            </button>
          </div>
