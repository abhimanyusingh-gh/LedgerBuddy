...
try:
    ...
    def scaled_dot_product_attention(
        ...
        if mask is not None:
            kwargs["mask"] = mask
        return mx.fast.scaled_dot_product_attention(queries, keys, values, **kwargs)
from mlx_vlm.models.deepseek_vl_v2.language import DeepseekV2Model, MoEGate, TextConfig as DeepseekTextConfig
